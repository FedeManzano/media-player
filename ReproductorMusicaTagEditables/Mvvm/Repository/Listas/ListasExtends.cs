...
namespace ReproductorMusicaTagEditables.Mvvm.Repository.Listas
{
    public static class ListasExtends
    {
        ...
        public static List<Cancion> BlanquearListado(this List<Cancion> origen, Cancion ca = null)
        {
        ...
        public static void GuardarListado(this List<Cancion> origen, string path)
        {
            if (!File.Exists(path))
                File.Create(path).Close();
            string output = JsonConvert.SerializeObject(origen, Formatting.Indented);
        ...
        public static List<Cancion> ObtenerListadoReproduccion(this string path)
        {
            return JsonConvert.DeserializeObject<List<Cancion>>(File.ReadAllText(path))
                                                       ?? new List<Cancion>();
        }
    }
}
