...
namespace ReproductorMusicaTagEditables.Mvvm.ViewModel
{
    public class DescargasViewModel: ReproductorViewModelBase
    {
        ...
        {
            Irg.TitutloVentana = "Youtube Descargas";
        ...
        public async void ConvertirVideo(DescargarCancionControl descarga)
        {
            ...
            if (string.IsNullOrEmpty(UriVideo) || 
                !Uri.IsWellFormedUriString(UriVideo, UriKind.Absolute) || 
                !Regex.IsMatch(UriVideo, "^(https:\\/\\/www.youtube.com\\/watch\\?)"))
            { 
                return;
            }
            else
